...
<html lang="en">
    ...
    <body class="insights post">
		...
		<div class="article-post light-header">
        <?php include('includes/header.php'); ?>
			<main>
				<section class="hero">
					<div class="hero__img">
						<picture>
							<source srcset="img/article-hero-mobile.jpg" media="(max-width: 550px)">
							<img src="img/article-hero-desktop.jpg" alt="" />
						</picture>
					</div>
					<div class="hero__text">
						<span class="hero__text__post-type">Article</span>
						<h1>The future of kitchen <br />technology</h1>
				...
				<section class="article-body">
					<div class="container">
						...
						<div class="share">
							...
							<ul>
								<li>
									<a href="http://www.linkedin.com/shareArticle?mini=true&url=http://localhost:3000/article.php" target="_blank" class="share-li">
										<img src="img/linkedin.svg" alt="" />
									</a>
								</li>
								<li>
									<a href="https://www.facebook.com/sharer.php?u=http://localhost:3000/article.php" target="_blank" class="share-fb">
										<img src="img/facebook.svg" alt="" />
									</a>
								</li>
								<li>
									<a href="https://twitter.com/share?url=http://localhost:3000/article.php&amp;text=The future of kitchen technology" target="_blank" class="share-tw">
										<img src="img/twitter.svg" alt="" />
									</a>
								</li>
								<li>
									<a href="mailto:?subject=Check out this article from Constrata.io&body=The future of kitchen technology: http://localhost:3000/article.php" class="share-em">
